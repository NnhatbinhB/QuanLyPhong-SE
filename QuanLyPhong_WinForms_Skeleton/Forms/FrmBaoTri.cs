...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmBaoTri : Form
    {
        public FrmBaoTri()
        {
            ...
            var lbl = new Label(){ Text="Yêu Cầu Sửa Chữa  Quản lý trạng thái sửa chữa", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
