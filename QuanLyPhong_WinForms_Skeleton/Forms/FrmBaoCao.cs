...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmBaoCao : Form
    {
        public FrmBaoCao()
        {
            ...
            var lbl = new Label(){ Text="Báo Cáo  Doanh thu/Chi phí/Công nợ/Lợi nhuận", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
