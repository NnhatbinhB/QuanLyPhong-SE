...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmVanTay : Form
    {
        public FrmVanTay()
        {
            ...
            var lbl = new Label(){ Text="Quản Lý Vân Tay  Auto-disable khi rời đi", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
