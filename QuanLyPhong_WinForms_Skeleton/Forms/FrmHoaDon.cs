...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmHoaDon : Form
    {
        public FrmHoaDon()
        {
            ...
            var lbl = new Label(){ Text="Quản Lý Hóa Đơn  Mapping dữ liệu, trạng thái thanh toán", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
