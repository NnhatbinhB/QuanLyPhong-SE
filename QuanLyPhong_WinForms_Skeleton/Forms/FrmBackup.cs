...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmBackup : Form
    {
        public FrmBackup()
        {
            ...
            var lbl = new Label(){ Text="Backup & Restore  Chọn file .bak để khôi phục", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
