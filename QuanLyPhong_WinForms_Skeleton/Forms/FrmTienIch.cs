...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmTienIch : Form
    {
        public FrmTienIch()
        {
            ...
            var lbl = new Label(){ Text="Quản Lý Tiện Ích  (TODO: thêm CRUD/logic)", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
