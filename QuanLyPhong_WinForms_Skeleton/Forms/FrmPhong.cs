...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmPhong : Form
    {
        public FrmPhong()
        {
            ...
            var lbl = new Label(){ Text="Quản Lý Phòng  (TODO: thêm CRUD/logic)", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
