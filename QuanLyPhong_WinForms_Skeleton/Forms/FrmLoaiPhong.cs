...
namespace QuanLyPhong_WinForms_Skeleton.Forms
{
    public class FrmLoaiPhong : Form
    {
        public FrmLoaiPhong()
        {
            ...
            var lbl = new Label(){ Text="Quản Lý Loại Phòng  (TODO: thêm CRUD/logic)", AutoSize=true, ForeColor=Color.OrangeRed, Font=new Font("Segoe UI", 12, FontStyle.Bold), Top=20, Left=20 };
